...
# Mecánicas
## Principal: Desafíos
La mayoría de aplicaciones educativas basan su juego en desafíos. Brindan la oportunidad de generar competitividad, pero a nivel personal, le permite al jugador potenciar o adquirir habilidades.
# Información
...
# Auxiliar: Puntos
Los puntos son un componente importante en cualquier estrategia de gamificación, porque consiste en darle valor a cualquier acción que haces en la aplicación. Estos puntos luego pueden ser utilizados para intercambios u otra acción.
...
# Dinámicas
## Principal: Logros
Se traza un mapa de hitos alcanzados por el jugador, permite reflejar claramente el avance del mismo. Es fácil de renovar. Se aplica de manera individual indiferente a la mecánica. (El jugador que hizo más daño)
...
Tipos de Logros
Los logros se basarán en los entrenamientos, cuando un usuario alcance cierto número de repeticiones por ejemplo en un ejercicio de flexiones, se le concederá un logro.
Regular Push ups y Dominadas
-	10 reps Pushups y 5 Dominadas (Héroe Clase-C)
-	25 reps Pushups y 10 Dominadas (Héroe Clase-B)
-	35 reps Pushups y 15 Dominadas (Héroe Clase-A) 
-	50 reps Pushups y 20 Dominadas (Héroe Clase-S)

# Auxiliar: Recompensa
Viene a ser algo más tangible por parte del usuario, no premia esfuerzo o avance si no participación, por el simple hecho de estar en el juego vas a tener una recompensa.
...
a.	Tipo de cuerpo
b.	Cálculo de macronutrientes / Calorías
c.	Objetivos o enfoque de entrenamiento
2.	Conceptualización sobre calistenia
a.	Definición
b.	Metodologías de entrenamiento.

Según el objetivo seleccionado diferirán las actividades y entrenamientos en cada mapa.
## Objetivos
-	Hipertrofia
-	Definición / Bajar de peso
-	Resistencia

Una vez se pase la parte de “Conocer al usuario y lo que quiere” empezará las etapas del juego. El juego se basa en 3 mapas, indiferente a los objetivos:
1.	Mapa Principiante
2.	Mapa Intermedio
3.	Mapa Avanzado
...
¿Cómo conseguir los puntos?
Habrá varias formas de recibir puntos, entre ellas:
-	Cada hora podrás recoger 5 pts. acumulables
-	Cada vez que realizas un desafío de cualquier tipo recibes cierta cantidad de puntos (estos se pueden ver en Actividades)
-	Cada vez que se termine un entrenamiento 10 pts.
-	Cada vez que el usuario avance un Mapa (Básico, Intermedio, Avanzado) 100 pts.

Con cada desafío completado conseguirás puntos acumulativos con los cuales podrán ser canjeados por bonos extras como entrenamientos de trucos como muscle ups, front levers etc., conocimientos extras o hasta recetas para pre o post workouts que estarán en la tienda del juego.
...
-	Rutina Muscle Ups = 900 pts.
-	Receta post Workout basada en proteínas = 700 pts.
-	Rutina Back Clap Pushups = 600 pts.
-	Receta pre Workout basada en proteínas = 600 pts.
-	Conocimiento extra (Tipo de fibras por músculos) = 500 pts.
-	Conocimiento extra (¿Cómo bajar de peso?) = 500 pts.
